...
Ansvarig medlemsstat ska fastställas på grundval av situationen vid den tidpunkt då ansökan om internationellt skydd först registrerades i en medlemsstat.
...
- [RULE-APR-027-001](../../registration/rules/rule-apr-027-001.md) — Skyldighet att registrera
